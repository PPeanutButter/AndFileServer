...
const file_detail_html = "<li class=\"mdc-list-item\">\n" +
                                     ...
                                     "</li>";
const dialog_actions_html = "<button type=\"button\" data-mdc-dialog-action=\"1\" class=\"mdc-button mdc-dialog__button dialog-copy\" onclick=\"onDialogButtonClick('{0}','copy')\">\n" +
